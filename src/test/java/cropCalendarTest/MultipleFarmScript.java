...
public class MultipleFarmScript {
    ...
    // Change this path as per your system
    private static final String OUTPUT_FOLDER = "/home/user/Downloads/Testing/AutmatedScriptTest/TestData/Crop Calendar/Single API Key/";   // as per folder --> you add path 
